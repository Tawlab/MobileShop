...
// 1. ตรวจสอบสิทธิ์ (ใช้ชื่อสิทธิ์ del_branch หรือตามที่คุณตั้ง)
...
// 3. ดึงข้อมูลสาขาก่อนลบ (เพื่อเอาชื่อและ ID ที่อยู่)
...
try {
    // A. ลบข้อมูลสาขา (Branches)
    // ถ้าสาขานี้ถูกใช้ใน employees, bill_headers, purchase_orders จะติด Error 1451 ตรงนี้
