<?php
// ============================================================
// gen_print_all.php – สร้าง print_all.php พร้อมหน้าปก
// ============================================================
$target = __DIR__ . '/print_all.php';
...
.cover-title{font-size:2.6rem;font-weight:800;line-height:1.2;margin:0 0 10px;position:relative;z-index:1;}
...
<div class="cover-page">
  ...
  <h1 class="cover-title">คู่มือการใช้งานระบบ</h1>
...
echo "OK: " . filesize($target) . " bytes → " . $target . "\n";
