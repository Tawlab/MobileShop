...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (empty($errors)) {
        ...
        try {
            ...
            $stmt_role_update->bind_param("i", $role_id_to_edit);
...
<head>
    ...
    <title>กำหนดสิทธิ์ บทบาท: <?= htmlspecialchars($role_data['role_name'] ?? '') ?></title>
                    ...
                    <form method="POST" action="role_permissions.php?id=<?= $role_id_to_edit ?>" id="editRolePermissionsForm">
                        ...
                        <div class="card">
                            <div class="card-header">
                                <h4 class="mb-0">
                                    <i class="fas fa-shield-alt me-2"></i>กำหนดสิทธิ์ (ID: <?= $role_id_to_edit ?>)
                                    <span class="fs-5 fw-normal text-white-50">| <?= htmlspecialchars($role_data['role_name'] ?? '') ?></span>
                                </h4>
                            </div>
                            ...
                            <div class="card-body">
                                ...
                                <div class="filter-form-container">
                                    <form method="GET" action="role_permissions.php" id="filterPermissionForm">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <?php if (!empty($search_perm) || $filter_type != 'all'): ?>
                                                <a href="role_permissions.php?id=<?= $role_id_to_edit ?>" class="btn btn-outline-secondary">ล้างกรอง</a>
                                            <?php endif; ?>
                                        </div>
                            ...
                            <div class="card-footer text-center bg-light p-3">
                                <div class="d-flex gap-2 justify-content-center">
                                    <button type="submit" class="btn btn-success">
                                        <i class="fas fa-save me-2"></i>บันทึกการกำหนดสิทธิ์
                                    </button>
