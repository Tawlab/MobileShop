...
<<<<<<< HEAD
        ...
        @media (max-width: 991.98px) {
            .container-box {
                /* ลด Padding และ Margin รอบกล่องบน Mobile */
                padding: 20px;
                margin-top: 15px;
                border-radius: 0; /* ทำให้เต็มขอบจอ */
            }

            /* 1. จัดการ Grid Layout (สมมติว่าใช้ class row/col) */
            .row > div[class*='col-'] { 
                margin-bottom: 10px; 
            }

            /* 2. ปรับขนาด Font ในตารางและฟอร์มควบคุม */
            .table th, .table td {
            ...
            /* 4. จัดการปุ่ม Action ในแต่ละแถว */
            .table td:last-child {
                display: flex;
            ...
            /* 5. ทำให้ปุ่มหลัก (Add Item, Save) ใช้เต็มความกว้าง (ถ้าใช้ d-grid) */
            .d-grid .btn {
                width: 100% !important;
                margin-bottom: 10px;
            }
