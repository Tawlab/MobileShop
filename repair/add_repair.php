...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    try {
        ...
        try {
            ...
            $current_shop_password = $shop_data['shop_app_password'];

            if (!empty($cust_email) && !empty($current_shop_email) && !empty($current_shop_password)) {
    ...
    <script>
        ...
        function searchEmployeeInModal(query) {
            ...
            fetch('', {
                    ...
                    body: `action=search_employee&query=${query}`
                })
                .then(res => res.json())
                .then(data => {
                    resultsBody.innerHTML = '';
