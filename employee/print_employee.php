<?php
// --- print_employee.php ---
// (หน้านี้เป็น "พรีวิว" และ "หน้าพิมพ์" ในตัวเดียว)

session_start();
require '../config/config.php'; // (ตรวจสอบ Path ให้ถูกต้อง)
...
// --- 2. ดึงข้อมูลพนักงาน (Query ฉบับสมบูรณ์ - เหมือน view_employee.php) ---
$sql = "
    SELECT
        e.*, 
        p.prefix_th, 
...
<head>
    ...
    <style>
        /* ===== 1. โหมด Screen (แสดงผลในเบราว์เซอร์) ===== */
        /* (สไตล์เดียวกับ view_employee.php) */
        body {
        ...
        @media print {
            ...
            .profile-image-lg {
                /* ใช้ Class เดิม แต่เปลี่ยนสไตล์ */
                width: 150px;
                height: 150px;
                border-radius: 8px;
            ...
            .row {
                ...
                margin-top: 0;
                margin-right: -5px;
                /* (ปรับ Gutter ของ Bootstrap) */
                margin-left: -5px;
                /* (ปรับ Gutter ของ Bootstrap) */
            }

            /* (บังคับคอลัมน์ - ต้องระบุให้ครบทุก col ที่ใช้ใน HTML) */
            .col-md-2,
            .col-2 {
                flex: 0 0 auto;
                width: 16.666667%;
            ...
            /* (สไตล์ Label/Value - ใช้สไตล์เดียวกับหน้าจอ แต่ลดขนาด/ระยะห่าง) */
            .info-label {
                display: block;
                font-size: 0.8rem;
                /* (ลดขนาด) */
